...
export default function GithubCardShiny({ className }: { className?: string }) {
    ...
    return (
        <div
            ref={containerRef}
            className={cn(
                "group relative max-w-full mx-2 sm:mx-20 md:mx-32 lg:mx-48 xl:mx-80 overflow-hidden rounded-3xl border text-zinc-200 shadow-lg",
                className
            )}
        >
            <div
            ...
            <div className={styles.sectionBox}>
                <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
                    <Image
                        src={pfp_1}
                        alt="PFP"
                        className="rounded-full size-24 md:size-48 lg:size-56 xl:size-64"
                    />
                    <div className="text-xs md:text-sm lg:text-base xl:text-xl flex flex-col gap-4">
                        <p>
