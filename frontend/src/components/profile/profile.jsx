function Profile() {
    return (
        <div className="bg-slate-900 w-fit rounded-3xl p-16 flex justify-center items-center gap-8">
            <img
                src="https://scotscoop.com/wp-content/uploads/2021/09/Profile-pic-template.png" //"https://upload.wikimedia.org/wikipedia/commons/thumb/2/2c/Default_pfp.svg/2048px-Default_pfp.svg.png" //"https://media.licdn.com/dms/image/v2/D4E03AQHCNqe5NW46-A/profile-displayphoto-shrink_200_200/B4EZRnDs5ZGgAY-/0/1736895811582?e=2147483647&v=beta&t=Y9fSewqHimTfUpQTZ99PgQNdokz82ELL3VMNUcSV2L8"
                alt="PFP"
                className="rounded-full size-64"
            />
            <ul className="flex flex-col justify-center items-center gap-1">
                <p className="text-xl">Hello, I am</p>
                <h1 className="font-bold text-5xl">Evan Leong</h1>
